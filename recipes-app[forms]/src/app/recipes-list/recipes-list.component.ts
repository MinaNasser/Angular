...
export class RecipesListComponent {
  recipes: Recipe[] = [];
  // recipecRequestsService = inject(RecipeRequestsService);


  constructor(private recipeRequestsService: RecipesRequestService) {}

  ngOnInit(): void {
    this.recipeRequestsService.getRecipes().subscribe((response) => {
